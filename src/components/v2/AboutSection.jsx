function AboutSection() {
    return (
      <section id="about" className="py-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto rounded-2xl my-12" style={{ backgroundColor: 'var(--section-background)' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div>
            <h3 className="text-2xl font-semibold mb-4 text-gray-800 dark:text-darkText">Who am I?</h3>
            <p className="text-gray-600 mb-6 dark:text-gray-400">
              I'm a passionate Full Stack Developer with 5+ years of experience creating digital products. I specialize in JavaScript frameworks and have a strong background in both frontend and backend development.
            </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
            {[
              ...
              { icon: 'mobile-alt', title: 'Mobile Apps', desc: 'Creating cross-platform mobile experiences (e.g., React Native)' },
              ...
              <div key={index} className="p-6 rounded-xl shadow-sm bg-card-background">
                <div className="text-4xl gradient-text mb-4">
                  <i className={`fas fa-${item.icon}`}></i>
                </div>
                <h4 className="font-semibold mb-2 text-gray-800 dark:text-darkText">{item.title}</h4>
